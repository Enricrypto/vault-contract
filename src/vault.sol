...
import {IPool} from "lib/openzeppelin-contracts/contracts/token/ERC20/ERC20.sol";
...
import {IStaderConfig} from "lib/ethx/contracts/interfaces/IStaderConfig.sol";
import {IStaderStakePoolManager} from "lib/ethx/contracts/interfaces/IStaderStakePoolManager.sol";
import {IUserWithdrawalManager} from "lib/ethx/contracts/interfaces/IUserWithdrawalManager.sol";
...
contract Vault is ERC4626 {
    ...
    modifier onlyOwner() {
        require(msg.sender == vaultAdministrator, "Caller not vault administrator");
        _;
    }
